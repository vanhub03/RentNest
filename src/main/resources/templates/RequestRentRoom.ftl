...
<head>
    ...
    <title>Yêu cầu thuê phòng mới</title>
    <style>
        ...
        .message-box { background-color: #fffbeb; border-left: 4px solid #f59e0b; padding: 15px; margin-top: 15px; font-style: italic; color: #475569; }
...
<div class="email-wrapper">
    <div class="email-content">
        ...
        <div class="email-body">
            <h2>Xin chào <span>${landlordName!"Chủ nhà"}</span>,</h2>
            <p>Bạn vừa nhận được một yêu cầu thuê phòng mới trên hệ thống RentNest. Dưới đây là thông tin chi tiết từ khách hàng:</p>

            <div class="info-box">
                <div class="info-row">
                    <span class="info-label">Phòng yêu cầu:</span>
                    <span class="info-value text-primary">${roomName} - ${hostelName}</span>
                </div>
                <div class="info-row">
            ...
            <#if requestMessage?? && requestMessage?has_content>
                <p style="margin-bottom: 5px; font-weight: 600;">Lời nhắn từ khách hàng:</p>
                <div class="message-box">
                    "${requestMessage}"
                </div>
            </#if>

            <p style="margin-top: 25px;">Vui lòng đăng nhập vào hệ thống để xem chi tiết, liên hệ với khách hàng và tiến hành duyệt yêu cầu (tạo hợp đồng nháp).</p>

            <div class="cta-button">
                <a href="${actionUrl}" target="_blank">Xem & Duyệt Yêu Cầu Ngay</a>
            </div>
        </div>
